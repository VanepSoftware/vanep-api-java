...
- [x] 1.3b Acrescentar `BLOCKED` ao enum, por pedido de revisão na #198 (D1). Entra **declaradamente incompleto**: não diz quem bloqueou quem e nada recusa proposta para par bloqueado — ver D9 e R8
- [ ] 1.3c **Acrescentar `BLOCKED` ao `vanep-diagram.dbml`.** É o único valor que não vem do canônico; sem isso o diagrama e o código divergem
- [ ] 1.3d **Abrir issue do R8**, encaixada na #42: `blocked_by` (ou tabela própria), quem desbloqueia (Q3), e a proposta recusando par bloqueado
