...
- **Fora de escopo:** Geocoding / mini-mapa; alias Google↔IBGE; endereço de dependente/escola (já usam `cityToken`; alinhamento numa change menor); importar distrito IBGE; frontend/mobile; `placeId` no endereço pessoal “para o futuro”.
