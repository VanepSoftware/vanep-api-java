...
class CityControllerTest {
  ...
  private void saveInactiveCityInDf(String name, String ibgeCode) {
    CityModel inactive = new CityModel();
    inactive.setState(states.findByUf("DF").orElseThrow());
    inactive.setName(name);
    inactive.setIbgeCode(ibgeCode);
    inactive.setActive(false);
    cities.save(inactive);
  }

  @Test
  void listWithoutSearchOmitsInactiveCities() throws Exception {
    saveInactiveCityInDf("Cidade Inativa", "5300110");
  ...
  @Test
  void listWithSearchOmitsInactiveCities() throws Exception {
    saveInactiveCityInDf("Brasília Inativa", "5300111");
