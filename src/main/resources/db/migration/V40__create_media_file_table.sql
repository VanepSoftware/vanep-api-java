...
comment on table media_file is
    'Metadado de arquivo binário. O byte mora no provider; aqui fica o rastro.';
...
create index media_file_owner_idx
    on media_file (owner_type, owner_id, purpose) where deleted_at is null;
